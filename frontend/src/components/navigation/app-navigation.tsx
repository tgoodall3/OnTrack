    ...
    <div className="relative md:hidden">
      ...
      {open && (
        <>
          ...
          <div
            id="mobile-nav-menu"
            className="fixed inset-x-4 top-24 z-[120] max-h-[75vh] overflow-y-auto rounded-3xl border border-border/70 bg-surface p-4 shadow-2xl shadow-primary/20 sm:inset-x-auto sm:right-6 sm:w-[360px] sm:top-28"
            aria-modal="true"
          >
